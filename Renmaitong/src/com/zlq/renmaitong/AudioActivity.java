...
public class AudioActivity extends Activity {
 ...
 final Handler handler = new Handler(){     
     @Override  
	    public void handleMessage(Message msg) {     
	        if(msg.what == 1){  
	        	timeSize++;
	        	timeTV.setText("录制"+SystemConfig.audiosecond+"秒，已经录音"+timeSize+"秒");
 ...
 private void startRecord() throws IllegalStateException, IOException {
	  ...
	  mediaRecord.setOutputFormat(MediaRecorder.OutputFormat.MPEG_4);//设置音频输出格式
	  mediaRecord.setAudioEncoder(MediaRecorder.AudioEncoder.AAC);//设置音频编码
	  if(audioFile == null){
