		...
		@Override  
	 	public void handleMessage(Message msg) {     
		       if(msg.what == 1){
		    	   ...
		    	   Toast.makeText(BingPhoneNumber.this, "�󶨳ɹ�", Toast.LENGTH_SHORT).show();
		    	   ...
		    	   progressDialog.dismiss();
		    	   Toast.makeText(BingPhoneNumber.this, "����������ֵ����", Toast.LENGTH_SHORT).show();
		       }else if(msg.what == 4){
		    	   progressDialog.dismiss();
		    	   Toast.makeText(BingPhoneNumber.this, "��������ʱ", Toast.LENGTH_SHORT).show();
		       }
		}   
	};  
	@Override
		...
		bindNumberMV.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(passwordEt.getText().toString().equals("") ||
					...
					Toast.makeText(BingPhoneNumber.this, "������ֻ�Ų���Ϊ��", Toast.LENGTH_SHORT).show();
				}else{
					if(imsi == null){
						Toast.makeText(BingPhoneNumber.this, "�޷���ȡ���ֻ�", Toast.LENGTH_SHORT).show();
					}else{
						progressDialog = ProgressDialog.show(BingPhoneNumber.this, "���ֻ���...", "���Ե�...", true, false);  
						new Thread(){  
				            @Override  
				        public void run(){     
				           try{  
