		...
		@Override  
	 	public void handleMessage(Message msg) {     
		       if(msg.what == 1){
		    	   ...
		    	   Toast.makeText(ResetPassword.this, "�������ɹ�", Toast.LENGTH_SHORT).show();
		    	   ...
		    	   progressDialog.dismiss();
		    	   Toast.makeText(ResetPassword.this, "����������ֵ����", Toast.LENGTH_SHORT).show();
		       }else if(msg.what == 4){
		    	   progressDialog.dismiss();
		    	   Toast.makeText(ResetPassword.this, "��������ʱ", Toast.LENGTH_SHORT).show();
		       }
		}   
	};  
	@Override
		...
		public void onClick(View v) {
			...
			case R.id.resetImageview:
				if(passwordEt.getText().toString().equals("") || newPasswordEt.getText().toString().equals("")){
					Toast.makeText(ResetPassword.this, "ԭ����������벻��Ϊ��", Toast.LENGTH_SHORT).show();
				}else{
					if(!newPasswordEt.getText().toString().equals(repeatPasswordEt.getText().toString())){
						Toast.makeText(ResetPassword.this, "���������벻��ͬ", Toast.LENGTH_SHORT).show();
					}else{
						progressDialog = ProgressDialog.show(ResetPassword.this, "�޸�����...", "���Ե�...", true, false);  
						new Thread(){  
				            @Override  
				        public void run(){     
				           try{  
