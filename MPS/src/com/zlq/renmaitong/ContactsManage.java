		...
		@Override  
	 	public void handleMessage(Message msg) {     
		       if(msg.what == 1){
		    	   ...
		    	   Toast.makeText(ContactsManage.this, "����ͨѶ¼�ɹ�", Toast.LENGTH_SHORT).show();
		    	...
		    	MyDatabaseHelper.deleteContacts(ContactsManage.this);
		   		...
		   		//����
//		   		allData = MyDatabaseHelper.selectContacts(ContactsManage.this, "С");
//		   		System.out.println("ģ���ѯ������"+allData.size());
...
//		    		   staffHeaderNumber.setText("");
		    	   ...
		    	   progressDialog.dismiss();
		    	   Toast.makeText(ContactsManage.this, "����������ֵ����", Toast.LENGTH_LONG).show();
		       }else if(msg.what == 4){
		    	   progressDialog.dismiss();
		    	   Toast.makeText(ContactsManage.this, "��������ʱ", Toast.LENGTH_LONG).show();
		       }
		}   
	};  
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(companyArrayList.isEmpty() && staffArrayList.isEmpty() ){
			progressDialog = ProgressDialog.show(ContactsManage.this, "����ͨѶ¼��...", "���Ժ�...", true, false);  
			new Thread(){  
	            @Override  
	        public void run(){     
	           try{  
