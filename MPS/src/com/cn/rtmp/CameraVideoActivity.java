...
public class CameraVideoActivity extends Activity {
		...
		@Override  
	 	public void handleMessage(Message msg) {     
		       if(msg.what == 2){
		    	   ...
		    	   progressDialog.dismiss();
		    	   Toast.makeText(CameraVideoActivity.this, "��������ʱ", Toast.LENGTH_SHORT).show();
		    	   myReturn();
		       }else if(msg.what == 8){
		    	   progressDialog.dismiss();
		    	   Toast.makeText(CameraVideoActivity.this, "�ϴ���Ƶ�ɹ�", Toast.LENGTH_SHORT).show();
		    	   myReturn();
		       }else if(msg.what == 9){
		    	   start();
		       }else if(msg.what == 10){
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    timer.schedule(task, 2000);//�ӳ�5���ִ��
	}
	...
	private void stop(){
		...
		if(isStart == true){
			progressDialog = ProgressDialog.show(CameraVideoActivity.this, "�����ϴ���Ƶ��...", "���Ե�...", true, false);  
			new Thread(){  
	            @Override  
	        public void run(){     
	           try{  
	   ...
	   private void uploadSuccess(String projNumber, String fileName, String fileType){
			...
			try {
				...
				if(resultStr.equals("")){
					...
					if(result.equals("ok")){
						handler2.sendEmptyMessage(8);//UI�߳��������UI�߳�  
...
//								setResult(RESULT_OK, (new Intent()).setAction("netError"));
								Toast.makeText(CameraVideoActivity.this, "����RTMP������ʧ��", Toast.LENGTH_SHORT).show();
							}
						}
					});
